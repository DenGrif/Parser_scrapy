...
for vacancy in vacancies:
    try:
        ...
        salary = vacancy.find_element(By.CSS_SELECTOR, 'div.pY3d2 span.magritte-text___pbpft_3-0-16').text
...
with open("hh05.csv", 'w', newline='', encoding='utf-8-sig') as file:
    writer = csv.writer(file, delimiter=';')  # Указываем разделитель ;
    writer.writerow(['Название вакансии', 'Название компании', 'Зарплата', 'Ссылка на вакансию'])
    writer.writerows(parsed_data)

print("Парсинг завершен. Данные сохранены в hh05.csv")
